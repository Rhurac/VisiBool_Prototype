...
''' <summary>
''' Main display for viewing in tabbed panes
''' </summary>
Public Class ctlSplitTabbed
    Implements IDisplay

    ''' <summary>
    ''' Constructs an instance of ctlSplitTabbed
    ''' </summary>
    ...
    Public Sub DisplayOutput() Implements IDisplay.DisplayOutput
        ...
        rteOutput.AppendText(cGlobals.GetFuncOutput(DECODER))
    ...
    Public Sub DisplayIndependentVars() Implements IDisplay.DisplayIndependentVars
        ...
        txtIndependentVars.Text = "S0 S1 M0 M1 M2 M3 D0 D1 D2 D3"
